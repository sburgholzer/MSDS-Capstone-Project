dset /mnt/data3/scott/1979data/narr-a_221_19790101_0000_000.grb
index /mnt/data3/scott/1979data/narr-a_221_19790101_0000_000.grb.idx
undef 9.999E+20
title /mnt/data3/scott/1979data/narr-a_221_19790101_0000_000.grb
*  produced by grib2ctl v0.9.15
* command line options: -verf /mnt/data3/scott/1979data/narr-a_221_19790101_0000_000.grb
dtype grib 221
pdef 349 277 lcc 1 -145.5 1 1 50 50 -107 32463 32463
xdef 1111 linear -250 0.333333
ydef 247 linear 8 0.333333
tdef 2 linear 00Z01jan1979 3hr
...
CLWMRprs 29 153,100,0 ** (profile) Cloud water [kg/kg]
...
HGTprs 29 7,100,0 ** (profile) Geopotential height [gpm]
...
ICMRprs 29 178,100,0 ** (profile) Ice mixing ratio [kg/kg]
...
MCONV850mb  0 135,100,850 ** 850 mb Horizontal moisture divergence [kg/kg/s]
...
MSLETmsl  0 130,102,0 ** mean-sea level Mean sea level pressure (Mesinger method) [Pa]
...
POT30m  0 13,105,30 ** 30 m above ground Potential temp. [K]
POT10m  0 13,105,10 ** 10 m above ground Potential temp. [K]
...
PRES30m  0 1,105,30 ** 30 m above ground Pressure [Pa]
PRES10m  0 1,105,10 ** 10 m above ground Pressure [Pa]
...
PRMSLmsl  0 2,102,0 ** mean-sea level Mean sea level pressure (Shuell method) [Pa]
...
SOILW0_10cm  0 144,112,10 ** 0-10 cm underground Volumetric soil moisture (frozen + liquid) [fraction]
SOILW10_40cm  0 144,112,2600 ** 10-40 cm underground Volumetric soil moisture (frozen + liquid) [fraction]
SOILW40_100cm  0 144,112,10340 ** 40-100 cm underground Volumetric soil moisture (frozen + liquid) [fraction]
SOILW100_200cm  0 144,112,25800 ** 100-200 cm underground Volumetric soil moisture (frozen + liquid) [fraction]
SPFHprs 29 51,100,0 ** (profile) Specific humidity [kg/kg]
SPFH30m  0 51,105,30 ** 30 m above ground Specific humidity [kg/kg]
SPFH10m  0 51,105,10 ** 10 m above ground Specific humidity [kg/kg]
...
TKEprs 15 158,100,0 ** (profile) Turbulent Kinetic Energy [J/kg]
TKEhlev1  0 158,109,1 ** hybrid level 1 Turbulent Kinetic Energy [J/kg]
TMPsfc  0 11,1,0  ** surface Temp. [K]
TMPprs 29 11,100,0 ** (profile) Temp. [K]
TMP30m  0 11,105,30 ** 30 m above ground Temp. [K]
...
TSOIL_800cm  0 85,111,800 ** 800 cm underground Soil temp. [K]
...
UGRDprs 29 33,100,0 ** (profile) u wind [m/s]
...
VGRDprs 29 34,100,0 ** (profile) v wind [m/s]
...
VVELprs 29 39,100,0 ** (profile) Pressure vertical velocity [Pa/s]
...
WCCONV00_700mb  0 241,101,70 ** 00-700 mb Water condensate flux convergence (vertical int) [kg/m^2]
WCCONVclm  0 241,200,0 ** atmos column Water condensate flux convergence (vertical int) [kg/m^2]
WCINC00_700mb  0 233,101,70 ** 00-700 mb water condensate added by precip assimilaition [kg/m^2]
WCINCclm  0 233,200,0 ** atmos column water condensate added by precip assimilaition [kg/m^2]
WCUFLX00_700mb  0 244,101,70 ** 00-700 mb Water condensate zonal transport (vertical int) [kg/m]
WCUFLXclm  0 244,200,0 ** atmos column Water condensate zonal transport (vertical int) [kg/m]
WCVFLX00_700mb  0 245,101,70 ** 00-700 mb Water condensate meridional transport (vertical int) [kg/m]
WCVFLXclm  0 245,200,0 ** atmos column Water condensate meridional transport (vertical int) [kg/m]
WEASDsfc  0 65,1,0  ** surface Accum. snow [kg/m^2]
WVCONV00_700mb  0 237,101,70 ** 00-700 mb Water vapor flux convergence (vertical int) [kg/m^2]
WVCONVclm  0 237,200,0 ** atmos column Water vapor flux convergence (vertical int) [kg/m^2]
WVINC00_700mb  0 232,101,70 ** 00-700 mb water vapor added by precip assimilation [kg/m^2]
WVINCclm  0 232,200,0 ** atmos column water vapor added by precip assimilation [kg/m^2]
WVUFLX00_700mb  0 242,101,70 ** 00-700 mb Water vapor zonal transport (vertical int)[kg/m]
WVUFLXclm  0 242,200,0 ** atmos column Water vapor zonal transport (vertical int)[kg/m]
WVVFLX00_700mb  0 243,101,70 ** 00-700 mb Water vapor meridional transport (vertical int) [kg/m]
WVVFLXclm  0 243,200,0 ** atmos column Water vapor meridional transport (vertical int) [kg/m]
ENDVARS
